...
import { dummyData } from '../utilityFunctions/dummyData'
...
const TransactionCard = ({addressTo, addressFrom, timestamp, message, keyword, amount, url})=>{
    ...
    return (
        <div className='bg-[#a10bb8] m-4 flex flex-1
        2xl:min-w-[450px]
        2xl:max-w-[500px]
        sm:min-w-[270px]
        sm:max-w-[300px]
        flex-col p-3 rounded-md hover:bg-[#07f5f1]'>
            <div className='flex flex-col items-center w-full mr-3'>
                <div className='w-full mb-6 p-2'>
                  ...
                  <div className=' p-3 px-5 w-max rounded-3xl -mt-5 shadow-2xl bg-[#64068a]'>
                      <p className='text-[#07f5f1] font-bold'>{timestamp}
